...
export const LINES = {
  ...
  throwIt: {
    id: 'e030-throw',
    text: "See the big fella? Punch towards him, and release the trigger at the end of the swing. I'll mark the spot.",
  },
  ...
  attachFree: { id: 'e074-attach-free', text: 'Try the others if you like. Hit ready when you are.' },
  attachLate: { id: 'e075-attach-retry', text: "Recall while it's still in the air — timing is everything." },

  // Beat 7 — graduation
  grad: {
    id: 'e080-grad',
    text: "That's everything I've got — and look at you now. Knock him down, and you're done. Make me proud, slugger.",
  },
  ...
  win: {
    id: 'e084-win',
    text: "Down goes the big fella. Well done, well done, well done. Gasket's waiting for you, Clanker.",
  },
  lose: {
    id: 'e085-lose',
